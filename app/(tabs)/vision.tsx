        ...
        <SafeAreaProvider className="flex-col">
            ...
            >
                ...
                >
                    ...
                    ></Image>
                    <Text
                        className="z-20 font-barlow-semibold text-2xl text-whs-blue w-full text-center relative bottom-7 p-5"
                    >HOME OF THE MARAUDERS
                    </Text>
                    <Text
                        className="z-20 font-source-serif-italic text-base text-gray-700 w-full text-center relative bottom-16 p-8"
                    >
                        Waipahu High School's vision is to provide student-centered educational programs that challenge all students to perform at their highest potential.
                    </Text>
                    <View className="relative bottom-24">
                        <Text
                            className="z-30 font-barlow-semibold text-whs-blue text-xl w-full text-center relative p-5"
                        >
                            CLASS OF 2025
                        </Text>
                        <View className="flex-wrap flex-row justify-center items-center gap-3">
                            <View className="w-[40vw] items-center px-4 bg-whs-blue h-[70vw]">
                                <Text
                                    className="z-20 font-source-serif-italic text-white w-[33vw] text-3xl text-center pl-8 pr-8 pt-4"
                                >
                                    29
                                </Text>
                                ...
                                <Text
                                    className="z-20 font-source-serif-italic text-white w-[33vw] text-nowrap text-3xl text-center pl-8 pr-8 pt-3"
                                >
                                    305
                                </Text>
                            ...
                            <View className="w-[40vw] items-center justify-center px-4 bg-whs-blue h-[70vw]">
                                <Text
                                    className="z-20 font-source-serif-italic text-white w-[33vw] text-3xl text-center pl-8 pr-8 self-center"
                                >
                                    238
                                </Text>
                            ...
                            <View className="w-[40vw] items-center justify-center px-4 bg-whs-blue h-[70vw]">
                                ...
                                <Text className="font-barlow-regular text-xs text-white text-center self-center">
                                    Seal of Biliteracy Awards - 34 with three languages & two with four languages
                                </Text>
                            </View>
                            <View className="w-[40vw] items-center justify-center px-4 bg-whs-blue h-[70vw]">
                                <Text
                                    className="z-20 font-source-serif-italic text-white w-[40vw] text-3xl text-center pl-8 pr-8 self-center"
                                >
                                    $32M
                                </Text>
                                <Text className="font-barlow-regular text-xs text-white text-center self-center">
                        ...
                        <Text
                            className="z-30 font-source-serif-600 text-whs-blue text-xl w-full text-center relative p-5"
                        >
                            School Mission
                        </Text>
                        <Text
                            className="z-20 font-source-serif-italic text-base text-gray-700 w-full text-center pl-8 pr-8"
                        >
                            Waipahu High School prepares students for success in the 21st century by engaging them in rigorous and relevant learning opportunities that promote academic, physical, and emotional growth.
                        </Text>
                         <Text
                            className="z-30 font-source-serif-600 text-whs-blue text-xl w-full text-center relative p-5"
                        >
                        ...
                        <Text
                            className="z-20 font-source-serif-regular text-sm text-gray-700 w-full relative left-5 pl-8 pr-8"
                        >
