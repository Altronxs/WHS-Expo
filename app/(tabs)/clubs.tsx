                        ...
                        {clubData.clubData?.map((feature, index) => (
                                <React.Fragment key={index}>
                                    <View className="w-[100vw] p-3 border-t-[1px] border-gray-200">
                                        <Text
                                            className="z-30 font-barlow-semibold text-whs-blue text-lg w-full relative left-2 p-5 pb-3 underline"
                                        >
                                            {feature.name}
                                        </Text>
                                        <View className="flex-row relative left-8">
                                            ...
                                            />
                                            <Text className="z-20 font-barlow-regular text-sm text-gray-700 pl-4 pr-4" >{feature.location}</Text>
                                            <Image
                                                ...
                                                style={{tintColor: 'gray'}}
                                            />
                                            <Text className="z-20 font-barlow-regular text-sm text-gray-700 pl-4">{feature.supervisor}</Text>
                                        </View>
